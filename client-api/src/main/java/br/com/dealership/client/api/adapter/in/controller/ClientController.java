package br.com.dealership.client.api.adapter.in.controller;
...
import br.com.dealership.client.api.core.usecase.UpdateClientUseCase;
...
public class ClientController {
    ...
    public ResponseEntity<Response<ClientDtoResponse>> createClient(@RequestBody @Valid final ClientDtoRequest request) throws ClientAlreadyExistsException, EmailAlreadyInUseException {
        ...
        return ResponseEntity.created(URI.create("/v1/dealership/clients/" + clientDtoResponse.cpf()))
                .body(response);
    }
